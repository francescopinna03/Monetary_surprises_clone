...
export COMPONENT_SUFFICIENCY_DRAWS=999
export PHASE_COMPONENT_CONTRAST_DRAWS=999
export INVARIANT_ATTRIBUTION_DRAWS=999
export LONG_HORIZON_ATTRIBUTION_DRAWS=999
